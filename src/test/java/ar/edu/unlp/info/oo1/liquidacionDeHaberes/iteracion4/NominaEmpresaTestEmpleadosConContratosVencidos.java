...
public class NominaEmpresaTestEmpleadosConContratosVencidos {
    ...
    @Test
    public void testEmpleadosConContratosVencidos_NingunEmpleado() {
        assertEquals(0, nominaEmpresa.empleadosConContratosVencidos().size());
    }

    @Test
    public void testEmpleadosConContratosVencidos_UnEmpleadoSinContratoVigente() {
        ...
        assertEquals(1, nominaEmpresa.empleadosConContratosVencidos().size());
    }

    @Test
    public void testEmpleadosConContratosVencidos_UnEmpleadoConContratoVigente() {
        empleado empleado = nominaEmpresa.buscarEmpleado("123456789");
        contrato contrato = new contratoDePlanta(LocalDate.now(), 5000.0, 
			200.0, 100.0);
        empleado.cargarContrato(contrato);
        assertEquals(0, nominaEmpresa.empleadosConContratosVencidos().size());
    }
